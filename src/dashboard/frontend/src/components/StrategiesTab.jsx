  ...
  return (
    ...
    >
      <p className="p" style={{ marginBottom: 14 }}>
        Composite weights <code>0.40·sharpe + 0.30·win − 0.20·|dd| + 0.10·(0.25−brier)</code> rank the pool. Promotion gate: <code>Sharpe ≥ 0.8 · win rate ≥ 45% · ≥ 7 days paper</code>. Underperformers killed after ≥ 7 days &amp; ≥ 10 trades.
      </p>
